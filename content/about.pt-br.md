...
* **Foco Estratégico:** Encaro a modernização não apenas como uma migração técnica, mas como uma disciplina que conecta arquitetura, economia da modernização e valor de negócio.
* **Experiência Regional:** Possuo ampla vivência em mercados do Brasil, México, Argentina, Chile, Peru e Colômbia, atendendo setores de serviços financeiros, varejo e telecomunicações.

## Rigor Acadêmico e Científico
Minha prática profissional é fundamentada por uma base educacional robusta e contínua:
* **Mestre em Ciência da Computação (Engenharia de Software):** Pesquisador na UTFPR, focado especificamente na modernização de legados, visando uma abordagem baseada em evidências para o setor.
...
## Docência e Compartilhamento de Conhecimento
Acredito no poder da educação para transformar o mercado:
* Atuei como **Professor Universitário** em cursos de pós-graduação, lecionando sobre arquitetura de nuvem, Kubernetes e plataformas distribuídas modernas.
* Sou palestrante e defensor de tecnologias emergentes, traduzindo tendências em estratégias práticas para clientes corporativos.
